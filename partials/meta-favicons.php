...
<link rel="apple-touch-icon-precomposed" sizes="57x57" href="=<?php echo get_template_directory_uri(); ?>/dist/img/favicons/
...
<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/dist/img/favicons/favicon-196x196.png" sizes="196x196" />
...
<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/dist/img/favicons/favicon-128.png" sizes="128x128" />
